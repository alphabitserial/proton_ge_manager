...
pub const REQUEST_URL: &str =
    "https://api.github.com/repos/GloriousEggroll/proton-ge-custom/releases?per_page=9999";
...
impl Release {
    pub fn fetch_metadata() -> Vec<Release> {
        ...
        ClientBuilder::new()
            ...
            .send()
            .expect("Retrieving release metadata failed")
            .json()
...
////////////////////////////////////////////////////////////////////
// Auto-generated from https://transform.tools/json-to-rust-serde //
////////////////////////////////////////////////////////////////////
